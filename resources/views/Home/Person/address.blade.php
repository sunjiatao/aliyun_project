						...
						<ul class="am-avg-sm-1 am-avg-md-3 am-thumbnails">
							...
							<li class="user-addresslist">
								...
								<div class="new-mu_l2a new-p-re">
									<p class="new-mu_l2cw">
										<span class="title">地址：{{$row->xhuo}}</span>
									</p>
								</div>
									...
									<form class="am-form am-form-horizontal">
										...
										<div class="am-form-group">
											<div class="am-u-sm-9 am-u-sm-push-3">
												<a class="am-btn am-btn-danger baocun">保存</a>
				...
				<ul>
					...
					<li class="person">
						...
						<ul>
							<li> <a href="#">个人信息</a></li>
							<li> <a href="#">安全设置</a></li>
							<li class="active"> <a href="/personaddress">收货地址</a></li>
						</ul>
					</li>
					<li class="person">
						<a href="#">我的交易</a>
...
<script type="text/javascript">
	...
	$(".baocun").click(function(){
		...
		xhuo = $("#user-intro").val();
		// arr.push(name,phone,xhuo);
		// alert(arr);
		$.get("/personaddressc",{name:name,phone:phone,xhuo:xhuo},function(data){
			// alert(data);
			if(data == 1){
				alert('添加地址成功,请刷新页面显示');
			}else if(data == 2){
				alert('添加地址失败,请重新添加');
			}
		});
